...
Just a plain simple natural language response.The Data would always be in context to the question asked. For example is the question is “What is the average rating?” and data is “4.3”, 
...
Make sure to note the column names to have some context, if needed, for your response.There can also be cases where you are given an entire dataframe in the Data: field. 
...
if __name__ == "__main__":
    # question = "All shoes with rating higher than 4.8 "
    # sql_query = generate_sql_query(question)
    # print(sql_query)
